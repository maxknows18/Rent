			...
			<div class="wthree_banner_info">
				...
				<section class="slider">
					<div class="flexslider">
						<ul class="slides">
							<li>
								<h3>Welcome to a gateway to making your life easier.</h3>
								<p>Here for you.</p>
								
							</li>
							<li>
								<h3>Our Mission.. </h3>
								<p>To make your rental expeirence just that little bit easier and smarter</p>
							...
							<li>
								<h3>Our Vision... </h3>
								<p>To simplify rentals by connecting renters and property owners through a transparent, convenient, and reliable platform.</p>
