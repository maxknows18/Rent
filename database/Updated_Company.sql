...
-- Table for Landlord Signup Data
...
CREATE TABLE tenants (
    ...
    employment_status ENUM('Formal Employment', 'Self-Employed', 'Unemployed') NOT NULL,
    current_employer VARCHAR(255),
    employment_verification_contact VARCHAR(15),
    income DECIMAL(10, 2),
