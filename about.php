...
<div class="about-wthree">
    <div class="container">
        ...
        <div class="furniture" style="background-color: #f9f9f9; padding: 30px; border-radius: 10px;">
            <div style="text-align: center;">
                <img src="images/about-icon.png" alt="About Us" style="width: 100px; margin-bottom: 20px;">
            </div>
            <p style="font-size: 1.1em; line-height: 1.8; text-align: justify; color: #333;">
                Mulenga Homes is a startup company created to streamline the management of rent and tenants for landlords. 
                Whether you’re looking to list your property or searching for your dream home, we are here to facilitate 
                the process with ease and efficiency. Our mission is to provide a seamless experience for landlords and tenants alike.
            </p>
        </div>
    </div>
</div>
				...
				<div class="container">
					...
					<div class="statistics-grids">
						<div class="col-md-3 statistics-grid">
							<div class="counter numscroller"> 1</div>
							<h5>Active users</h5>
						</div>
						<div class="col-md-3 statistics-grid">
							<div class="counter numscroller">1</div>
						...
						<div class="col-md-3 statistics-grid">
							<div class="counter numscroller">0</div>
